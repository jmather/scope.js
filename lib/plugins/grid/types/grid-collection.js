 ...
 * @returns {*}
 */
GridCollectionType.prototype.setValue = function(name) {
    throw new Error("Cannot setValue on a GridCollection");
};
 ...
 * @returns {*}
 */
GridCollectionType.prototype.clearValue = function() {
    throw new Error("Cannot clearValue on a GridCollection");
};
