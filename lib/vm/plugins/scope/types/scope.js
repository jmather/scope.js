...
var dots = require('../../../../internal/dot');

/**
 * @typedef {string} ChoiceExpression
 */

/**
 * @typedef {Object} ChoiceInstruction
 */
...
/**
 *
 * @param {{ when: ChoiceExpression[], notWhen: ChoiceExpression[], instructions: ChoiceInstruction[] }} choice
