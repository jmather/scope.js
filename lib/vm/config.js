...
var InstructionExecutor = require('./instruction-executor');
...
VMConfig.prototype.getInstructionExecutor = function() {
    if (this.instructionExecutor === null) {
        this.instructionExecutor = new InstructionExecutor(this.getInputManager(), new QuestionManager(), this.plugins);
    }
